...
let bankQuestionsRetryTimer = null;
        ...
        function normalizeSource(raw) {
            ...
            // 否则会误伤真实标题（如「公式保真测试卷」末二字被截掉）。与 mathbank.source_normalize 保持一致。
            var NOISE = ['数学试题', '数学试卷', '（原卷版）', '(原卷版)', '（解析版）', '(解析版)', '（全国通用）', '(全国通用)', '（理科）', '(理科)', '（文科）', '(文科)', '解析版', '原卷版', '（1）', '(1)', '（2）', '(2)', '（3）', '(3)', '（5月份）', '(5月份)', '（10月份）', '(10月份)', '（六）', '(六)'];
