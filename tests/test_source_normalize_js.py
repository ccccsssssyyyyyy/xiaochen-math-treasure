...
def test_js_backend_parity(func_src):
    ...
    zhoulian = [
        ...
        "第一中学高2028届高一上第三周周练", # 「周」字重复的真实文件名写法
    ]
    # 新增规约（模拟 / 联考 / 教辅）与高考真题分隔符幂等：
    # 这些若前后端不同步，会出现「前端预览显示原始串、落库却已归一」的错位。
    new_rules = [
        "2025 · 江苏盐城模拟", "2025 · 江苏模拟", "2025 · 天津模拟",
        "2025 · 四川内江模拟", "2024 · 重庆模拟", "2024 · 全国模拟",
        "2025 · T8联考", "2024 · 九省联考", "2024 · 江苏南通模拟",
        # 已合规则须幂等（含高考真题的两种分隔符）
        "2025 · 江苏盐城 · 模拟", "2024 · 九省 · 联考",
        "2023·全国甲卷·高考真题", "2023 · 全国甲卷 · 高考真题",
        "教辅 · 一数必刷100题", "高考 · 专题汇编 · 数列",
    ]
    extras = [
        "", None, "   ",
